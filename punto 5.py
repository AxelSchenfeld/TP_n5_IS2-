# Modifique el programa IS2_taller_memory.py para que la clase tenga la capacidad de almacenar hasta 4 estados 
# en el pasado y pueda recuperar los mismos en cualquier orden de ser necesario. El método undo deberá tener un
# argumento adicional indicando si se desea recuperar el inmediato anterior (0) y los anteriores a el (1,2,3).
import os
class Memento:
...
class FileWriterUtility:
    ...
    def save(self):
        ...
        if len(self.history) > 4:  # Limitar el historial a los últimos 4 estados
            self.history.pop(0)
